#!/usr/bin/env bash
# Install the MSYS2 packages needed to build pdfgrep for 64-bit UCRT.
# Run from an MSYS2 UCRT64 shell, not from PowerShell or cmd.exe.
...
# The UCRT packages provide the target compiler and libraries; the unprefixed
